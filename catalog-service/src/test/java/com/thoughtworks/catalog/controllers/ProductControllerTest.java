package com.thoughtworks.catalog.controllers;


import com.thoughtworks.catalog.AbstractIntegrationTest;
...
class ProductControllerTest extends AbstractIntegrationTest {
    ...
    void shouldReturnNotFoundWhenProductCodeNotExists() {
        String prod_code = "invalid_product_code";
        given().contentType(ContentType.JSON)
                .when()
                .get("/api/products/{code}", prod_code)
                .then()
                .statusCode(404)
                .body("status", is(404))
                .body("title", is("Product Not Found"))
                .body("detail", is("Product with code " + prod_code + " not found"));
